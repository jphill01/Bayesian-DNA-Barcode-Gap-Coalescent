...
Equations (1)-(4) can thus be written in terms of ECDFs as follows, since the true underlying $F$s, are unknown \textit{a priori}, and therefore must be estimated using available sequence distance data:
