...
Results of the Bayesian coalescent-informed model outlined herein for all molecular gene loci and \textit{Agabus} species can be reproduced entirely using the R script provided within the \textbf{Supplementary Information} accompanying this paper. The included ``point-and-click" script will automatically generate and save all required data and visualizations locally to a user's working directory.
