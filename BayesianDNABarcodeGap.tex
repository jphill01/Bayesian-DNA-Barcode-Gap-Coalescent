...
Bayesian posterior estimates were reported alongside frequentist MLEs, in addition to SEs, posterior SDs, 95\% CIs and 95\% CrIs (\textbf{Table 2}). ECDF plots are also displayed and show a 
...
\caption{ECDF plots of the DNA barcode gap metrics for \textit{A. bipustulatus} and \textit{A. nevadensis}. When all genetic are equal to zero, no step function is shown.}
