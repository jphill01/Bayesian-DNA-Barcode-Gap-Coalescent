...
\caption{ECDF plots of the DNA barcode gap metrics for \textit{A. bipustulatus} and \textit{A. nevadensis}. When all genetic distances are equal to zero, no step function is shown.}
