...
%\noindent \textbf{Word Count}: 9300 (approx.)
...
Model findings for 5'-COI and 3'-COI were found to be quite similar to those in \citep{phillips2024measure}. Figure 3 in \citet{phillips2024measure} shows a handful of species, such as \textit{A. thomsoni} ($N$ = 8, $H$ = 5) and \textit{A. arcticus} ($N$ = 46, $H$ = 10) for 5'-COI, and \textit{A. ambiguus} ($N$ = 2, $H$ = 2) and \textit{A. nebulosus} ($N$ = 49, $H$ = 13) for 3'-COI, with wide ranging estimates for the DNA barcode gap metrics. Those results are consistent with the ones outlined herein. All results pertaining to these markers can be found in the \textbf{Supplementary Information} or by running the R script.
