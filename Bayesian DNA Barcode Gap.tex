...
\caption{MCMC parameter traceplots applied to \textit{A. bipustulatus} ([1]) and \textit{A. nevadensis} ([2]) for CYTB across 2000 iterations.}
...
\caption{Nonparametric frequentist and Bayesian estimates of pairwise genetic distance distribution overlap/separation for the DNA barcode gap coalescent model parameters applied to \textit{A. bipustulatus} and \textit{A. nevadensis} for CYTB, including 95\%  CIs and CrIs. CrIs are based on 4000 posterior draws. All parameter estimates are reported to three decimal places of precision.}
...
\caption{Bayesian posterior draws (black solid points) for \textit{A. bipustulatus} across CYTB. MLEs and posterior means are displayed as coloured (red/blue) solid and dashed lines for the metrics, respectively.}
...
\caption{Bayesian posterior draws (black solid points) for \textit{A. nevadensis} across CYTB. MLEs and posterior means are displayed as coloured (red/blue) solid and dashed lines for the metrics, respectively.}
