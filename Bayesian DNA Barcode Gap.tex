...
The model was fitted using the Stan probabilistic programming language  \citep{carpenter2017stan} framework for Hamiltonian Monte Carlo (HMC) sampling with a default of four Markov chains and 2000 iterations, as well as default settings for leapfrog integration (\textit{e.g.}, step size) via the No-U-Turn Sampler (NUTS) algorithm \citep{hoffman2014no}.
