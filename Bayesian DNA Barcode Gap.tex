...
\textbf{Parameter} & \textbf{MLE (95\% CI)} & \textbf{Bayes Est. (95\% CrI)} \\  \hline
$p_x/p_\mathrm{lwr}$ & & \\
$q_x/p_\mathrm{upr}$ & & \\
$p^{'}_x/p^{'}_\mathrm{lwr}$ & & \\
$q^{'}_x/p^{'}_\mathrm{upr}$ & & \\
...
\caption{Nonparametric frequentist and Bayesian estimates of pairwise genetic distance distribution overlap/separation for the DNA barcode gap coalescent model parameters, including 95\% confidence and credible intervals. CrIs are based on 4000 posterior draws.}
