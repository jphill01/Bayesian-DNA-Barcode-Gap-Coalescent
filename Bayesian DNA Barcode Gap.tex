...
\caption{MCMC parameter traceplots applied to \textit{A. bipustulatus} and \textit{A. nevadensis} for CYTB across 2000 iterations.}
...
\caption{Nonparametric frequentist and Bayesian estimates of pairwise genetic distance distribution overlap/separation for the DNA barcode gap coalescent model parameters applied to \textit{A. bipustulatus} and \textit{A. nevadensis} for CYTB, including 95\% confidence and credible intervals. CrIs are based on 4000 posterior draws. All parameter estimates are reported to three decimal places of precision.}
