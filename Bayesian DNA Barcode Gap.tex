...
A simple statistical model of the DNA barcodw gap is outlined. Specifically, \\ accuracy of novel nonparametric metrics, inspired by coalescent theory, to characterize the extent of propotional overlap/separation in pairwise genetic distances within and among species, is explored in a Bayesian context using Empirical Cumulative \\ Distribution Function (ECDF). The proposed estimators and model have a strong potential to shed light on interesting foundational and applied questions concerning specimen identification and species delineation for biodiversity conservation and \\ managenment.
